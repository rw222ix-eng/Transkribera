...
(() => {
  ...
  let finnsRedan = [];
  const best = t => t === 'Tavla' ? 'tavlan' : t === 'Prov' ? 'provet' : t === 'Arbetsblad' ? 'arbetsbladet' : 'gruppuppgiften';
  ...
  const RUB = { Tavla: 'Dagens tavla', Prov: 'Nytt prov', Arbetsblad: 'Nytt arbetsblad', Gruppuppgift: 'Ny gruppuppgift' };
