...
- [ ] **Step 1: Load the vendored KaTeX from the Svelte entry**
...
- [ ] **Step 2: Create `frontend/src/lib/math.js`**
...
- [ ] **Step 3: Use it in `ProvCard.svelte`**
...
- [ ] **Step 1: Add the selection to the exam store**
...
- [ ] **Step 2: Port the Swedish list grammar into `actions.js`**
...
- [ ] **Step 3: Scope the refine payload**
...
- [ ] **Step 4: Add the per-task control to `ProvCard.svelte`**
...
- [ ] **Step 5: Tell the user what the change will target**
...
- [ ] **Step 3: Approve into a real PDF from `/next`**
